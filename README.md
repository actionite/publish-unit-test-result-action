...
| `check_run_disabled`               |                        `false`                        | If set to `true`, then the creation of a check runs is disabled completely. This also implies `compare_to_earlier_commit` is also set to `false` implicitly.                                                                                                              |
